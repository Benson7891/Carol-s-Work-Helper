...
const USERS = [
  { id: 'carol', name: 'Carol', short: 'C', email: '13726111370@163.com', passwordHash: '06ce4485ed686bacad6a273b7ec44ecfd399380f9a86088cab80e8b86468bfcd', roleKey: 'role.carol', admin: true },
];
...
let session = load(KEY.session, null);    // 单人版只有 Carol 一个账号
const state = {
...
function visibleMatters(user) {
  return matters.filter(m => !m.deletedAt);
}
